...
- **Global scope**: `/home/dev/projects/llm-pilot/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/dev/projects/llm-pilot/.claude/notes/`)
...
2. Glob `/home/dev/projects/llm-pilot/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/dev/projects/llm-pilot/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/dev/projects/llm-pilot/.claude/notes/` — works in any directory
