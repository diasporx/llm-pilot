...
Use template from `/home/dev/projects/llm-pilot/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/dev/projects/llm-pilot/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/dev/projects/llm-pilot/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
