...
Reference full template: `/home/dev/projects/llm-pilot/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/dev/projects/llm-pilot/.claude/get-shit-done/templates/state.md`.
